...
const QUESTIONS = [
  ...
  q("modal", "It ___ rain tonight. に入る、控えめな可能性を表す語は？", ["might", "must", "has to", "should have"], "might", "mightはmayより控えめに可能性を述べる語。ここでは過去形や仮定法ではなく、現在の推量を表す。"),
  ...
  q("nouns", "I saw ___ dog in the park. に入る語は？", ["a", "the", "an", "some"], "a", "初めて導入するdogを、同種のものの中の1匹として表すためaを使う。すでに共有認識されている特定の犬ならtheになる。"),
