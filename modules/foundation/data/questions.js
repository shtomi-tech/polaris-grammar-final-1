...
const QUESTION_RULE_REFS = {
  ...
  q133: ["egp.conditionals-subjunctive.past-subjunctive"],
  q134: ["egp.conditionals-subjunctive.mixed-subjunctive"],
...
const QUESTIONS = [
  ...
  q("conjunction", "the fact ___ she won の that節の働きは？", ["factの内容を示す同格の名詞節", "factを選ぶ関係代名詞節", "主節の条件を示す副詞節", "前置詞句"], "factの内容を示す同格の名詞節", "that she wonはfactの内容を示す名詞節。名詞を選別する関係代名詞のthatとは異なる。"),
